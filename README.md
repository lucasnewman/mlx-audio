...
| **Nemotron 3.5 ASR (streaming)** | NVIDIA's cache-aware streaming FastConformer-RNNT with language-ID prompting | 40 language-locales | [Rahim/nemotron-3.5-asr-streaming-0.6b-mlx](https://huggingface.co/Rahim/nemotron-3.5-asr-streaming-0.6b-mlx) · [README](mlx_audio/stt/models/nemotron_asr/README.md) |
